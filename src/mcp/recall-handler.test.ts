...
describe('RecallHandler', () => {
  ...
  beforeEach(() => {
    ...
    mockFormatRecallResponse = formatters.formatRecallResponse as jest.MockedFunction<
      typeof formatters.formatRecallResponse
    >;
    ...
    mockIsQueryPurelyQuality = unifiedScoring.isQueryPurelyQuality as jest.MockedFunction<
      typeof unifiedScoring.isQueryPurelyQuality
    >;
